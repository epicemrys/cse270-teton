...
class TestSmokeTest():
  ...
  def test_homePage(self):
    ...
    self.driver.set_window_size(1202, 569)
  ...
  def test_directoryPage(self):
    self.driver.get("http://127.0.0.1:5500/cse270/teton/1.6/index.html")
    self.driver.set_window_size(1210, 636)
  ...
  def test_joinPage(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Charles")
    self.driver.find_element(By.NAME, "lname").send_keys("Ukoh")
  ...
  def test_adminPage(self):
    self.driver.get("http://127.0.0.1:5500/cse270/teton/1.6/index.html")
    self.driver.set_window_size(1204, 618)
    self.driver.find_element(By.LINK_TEXT, "Admin").click()
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("notuser")
    self.driver.find_element(By.ID, "password").send_keys("unworded")
